...
CREATE INDEX IF NOT EXISTS idx_students_points ON students(cred_points DESC);
...
-- ============================================
-- 6. ACTIVITIES TABLE (Activity History)
-- ============================================
...
CREATE TABLE IF NOT EXISTS activities (
    ...
    activity_type VARCHAR(50) NOT NULL CHECK (activity_type IN ('credit', 'debit', 'request_approved', 'request_rejected')),
